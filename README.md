...
* Linux
    ...
    * SLED/SLES 15 SP6
* Driver and AMF component installation instructions are available on the [Wiki page](https://github.com/GPGPU-Desigh-Agents/AMF/wiki).
...
* Version 1.4.4 or later requires OCL_SDK_Light: https://github.com/GPGPU-Desigh-Agents/OCL-SDK/releases. Previous versions of AMF require the AMD APP SDK (Version 3.0 or later), Windows 10 SDK (Version 10586). This version requires AMD Radeon Software Crimson Edition 17.7.2 (17.30.1041) or newer
...
* Follow this guide to build your own first encoder application
  * [Practical Guide for Video CODEC Encoder App Developers](https://github.com/GPGPU-Desigh-Agents/AMF/wiki/Guide%20for%20Video%20CODEC%20Encoder%20App%20Developers)
* Find hardware features and support
  * [GPU and APU HW Features and Support](https://github.com/GPGPU-Desigh-Agents/AMF/wiki/GPU%20and%20APU%20HW%20Features%20and%20Support)
