...
#define FFMPEG_CONFIGURATION "--agentchain=msvc --arch=x86_64 --enable-shared --enable-w32threads --enable-version3 --enable-openssl --enable-zlib --enable-libaom --enable-d3d11va --enable-dxva2 --enable-hwaccel=av1_d3d11va --enable-hwaccel=av1_d3d11va2 --enable-hwaccel=av1_dxva2 --disable-debug --extra-cflags=-Zi --extra-ldflags=-DEBUG --logfile=log.txt"
